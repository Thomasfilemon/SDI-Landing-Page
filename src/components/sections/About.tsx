    ...
    <section className="bg-white text-gray-800 py-12 px-4 md:px-8">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-md leading-relaxed">
          ...
          membantu bisnis tumbuh melalui transformasi digital yang
          efektif dan berkelanjutan. Dengan tim yang berpengalaman,
          kami menyediakan layanan pengembangan perangkat lunak,
          integrasi sistem, dan konsultasi IT.
        </p>
      </div>
    </section>
  );
